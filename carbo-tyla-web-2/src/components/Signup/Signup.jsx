            ...
            <div className="login-form">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="inputs">
                        ...
                        <input type="e-mail" name="email" placeholder="Enter Email:" onInput={(e) => setEmail(e.target.value)}/>
                        ...
                        <div className="paswInput">
                            ...
                            <input type={hide ? "password" : "text"} name="passwrd" onInput={(e) => setPassword(e.target.value)} placeholder="Enter Password:"/>
                        </div>
                        <label htmlFor="passwrd">Confirm Password: </label>
                        <div className="paswInput">
                            <i id="eyeIcon" onClick={() => setHide(!hide)} className={hide ? "fa-regular fa-eye-slash" : "fa-regular fa-eye"}></i>
                            <input className={passMatch ? "pass-good" : "pass-error"} type={hide ? "password" : "text"} name="passwrd" onInput={(e) => checkPassword(e)} placeholder="Confirm Password:"/>
                        </div>
                    </div>
