            ...
            <div className="login-form">
                ...
                <form onSubmit={handleLogin}>
                    <div className="inputs">
                        ...
                        <input type="e-mail" name="email" onChange={(e) => setEmail(e.target.value)} placeholder="Enter Email:"/>
                        ...
                        <div className="paswInput">
                            ...
                            <input type={hide ? "password" : "text"} name="passwrd" onChange={(e) => setPassword(e.target.value)} placeholder="Enter Password:"/>
                        </div>
                    </div>
